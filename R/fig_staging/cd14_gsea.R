cd14_gsea_plot <- pmap(.l = list(gene_set = c("GSE9988_LOW_LPS_VS_VEHICLE_TREATED_MONOCYTE_UP",
...
cd14_gsea_plots_combined <- cd14_gsea_plot$GSE9988_LOW_LPS_VS_VEHICLE_TREATED_MONOCYTE_UP / 
  cd14_gsea_plot$MOSERLE_IFNA_RESPONSE +
